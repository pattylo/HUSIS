...
{
    cout<<"vicon 1"<<endl;
    ros::init(argc, argv, "vicon1"); //initialize ROS via passing argc argv. the "offb_node" will be the name of your node's name
...
//    cout<<"hi"<<endl;
    ofstream ds("/home/patrick/d_1.txt", ios::app);
    ds<<d10<<endl;
    ds<<d12<<endl;
    ds<<d10f<<endl;
    ds<<d12f<<endl;
